                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo htmlspecialchars($row['CategoryName']); ?>" name="CategoryName"> <!-- Update here -->
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="modal fade" id="deletecategory<?php echo $row['CategoryID']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h3 class="text-center"><?php echo htmlspecialchars($row['CategoryName']); ?></h3> <!-- Update here -->
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Close</button>
...
<div class="modal fade" id="addcategory" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal"><span class="glyphicon glyphicon-remove"></span> Close</button>
                <button type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Add</button>
                </form>
            </div>
        </div>
        <!-- /.modal-content -->
